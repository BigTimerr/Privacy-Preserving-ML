...
# 加载数据
# trainset = torchvision.datasets.MNIST(root='ModelAndLayers/AlexNetAndMnist/data', train=True, download=True,
#                                       transform=transform)
#
# trainloader = torch.utils.data.DataLoader(trainset, batch_size=100, shuffle=True,
#                                           num_workers=0)  # windows下num_workers设置为0，不然有bug

testset = torchvision.datasets.MNIST(root='ModelAndLayers/AlexNetAndMnist/data', train=False, download=True,
